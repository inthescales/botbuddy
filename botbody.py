...
class BotBody(Responsive, Credentialed):
    ...
    def __init__(self):
        self.creds_file = BotBody.default_creds_file
        self.start = BotBody.default_start
        self.interval = BotBody.default_interval
        self.retry = BotBody.default_retry
        self.test_mode = False
        self.verbosity = BotBody.default_verbosity
